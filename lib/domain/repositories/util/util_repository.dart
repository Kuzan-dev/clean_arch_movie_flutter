...
abstract class UtilRepository{
  ...
  // Get actor details
  Future<Either<NetworkException, ActorDetailEntity>>getActorDetails({required int id});

  // Get actor movies
  Future<Either<NetworkException, List<ActorMovieEntity>>>getActorMovies({required int id});
